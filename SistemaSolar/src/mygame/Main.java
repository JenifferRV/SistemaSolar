...
public class Main extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        Sphere marte = new Sphere(30, 30, 0.6f);
        ...
        Material matRo = new Material(assetManager, "Common/MatDefs/Misc/Unshaded.j3md");
        matRo.setColor("Color", ColorRGBA.Red);
        geomMarte.setMaterial(matRo);
        ...
        nodeMercurio.setLocalTranslation(1.5f, 0, -2f);
        nodeVenus.setLocalTranslation(2.5f, 0, 0f);
        nodeTierra.setLocalTranslation(4f, 0, -1f);
        nodeMarte.setLocalTranslation(6f, 0,1f);
        
        
        pivot.attachChild(nodeSol);
        pivot.attachChild(nodeMercurio);
        pivot.attachChild(nodeVenus);
    ...
    public void simpleUpdate(float tpf) {
        ...
        **/
        rootNode.getChild("nodo_mercurio").rotate(0,tpf/3,0);
        rootNode.getChild("nodo_venus").rotate(0,tpf/2,0);
        ...
        rootNode.getChild("nodo_marte").rotate(0,tpf*2, 0);
